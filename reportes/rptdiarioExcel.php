...
while ($row = mysql_fetch_array($datos)) {
	...
	$objPHPExcel->setActiveSheetIndex(0)
    ->setCellValue('A'.$i, $row['permisoembarque']) // Titulo del reporte
    ->setCellValue('B'.$i, $row['color'])
    ->setCellValue('C'.$i, $row['fecha'])
    ->setCellValue('D'.$i, $row['razonsocial'])
    ->setCellValue('E'.$i, $row['cantidad'])
    ->setCellValue('F'.$i, '0')
    ->setCellValue('G'.$i, $row['contenedor'])
    ->setCellValue('H'.$i, $row['booking'])
    ->setCellValue('I'.$i, $row['destino'])
    ->setCellValue('J'.$i, $row['puerto'])
    ->setCellValue('K'.$i, 'AG Martin')
    ->setCellValue('L'.$i, $row['precinto'])
    ->setCellValue('M'.$i, '')
