...
"usuarios"        => "dbusuarios",        
"exportaciones"       => "dbexportaciones",       
"predio_menu"     => "predio_menu",       
"exportacioncontenedores"  => "dbexportacioncontenedores",                 
"roles"           => "tbroles",                            
"exportaciondetalles"        => "dbexportaciondetalles",
"buques"		=>	"tbbuques",
"colores"		=>	"tbcolores",
"destinos"		=>	"tbdestinos",
"mercaderias"		=>	"tbmercaderias",
"puertos"		=>	"tbpuertos",
"agencias"		=>	"tbagencias",
"clientereferentes" => "dbclientereferentes",
"agenciareferentes" => "dbagenciareferentes");
...
"exportaciones"       => 5,       
"predio_menu"     => 1,       
"exportacioncontenedores"  => 2,                 
"roles"           => 1,                            
"exportaciondetalles"        => 2,
"buques"		=>	1,
"colores"		=>	1,
"destinos"		=>	1,
"mercaderias"		=>	1,
