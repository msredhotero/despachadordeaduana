...
$resResultado = $serviciosReferencias->traerExportaciondetallesPorId($id);
...
$eliminar = "eliminarExportaciondetalles";

$modificar = "modificarExportaciondetalles";

$idTabla = "idexportaciondetalle";
...
$cadRef 	= $serviciosFunciones->devolverSelectBoxActivo($resVar1,array(2),'', mysql_result($resResultado,0,'refexportacioncontenedores'));

$resVar2 	= $serviciosReferencias->traerMercaderias();
$cadRef2 	= $serviciosFunciones->devolverSelectBoxActivo($resVar2,array(1),'', mysql_result($resResultado,0,'refmercaderias'));

//die(var_dump($cadRef3));
$refdescripcion = array(0 => $cadRef,1 => $cadRef2);
$refCampo 	=  array("refexportacioncontenedores","refmercaderias");
//////////////////////////////////////////////  FIN de los opciones //////////////////////////
...
$(document).ready(function(){
	...
	$('.volver').click(function(event){
		...
		url = "modificarcontenedor.php?id=<?php echo mysql_result($resResultado,0,'refexportacioncontenedores'); ?>";
