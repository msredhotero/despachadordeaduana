...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Destinos",$_SESSION['refroll_predio'],'');
...
$eliminar = "eliminarDestinos";

$insertar = "insertarDestinos";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerDestinos(),1);
