...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Colores",$_SESSION['refroll_predio'],'');
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerColores(),1);
