...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Mercaderias",$_SESSION['refroll_predio'],'');
...
$eliminar = "eliminarMercaderias";

$insertar = "insertarMercaderias";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerMercaderias(),1);
