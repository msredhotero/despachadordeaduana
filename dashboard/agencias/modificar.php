...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Agencias",$_SESSION['refroll_predio'],'');


$id = $_GET['id'];

$resResultado = $serviciosReferencias->traerAgenciasPorId($id);
...
$eliminar = "eliminarAgencias";

$modificar = "modificarAgencias";
...
$resContactosCountries = $serviciosReferencias->traerAgenciareferentesPorAgencia($id);
