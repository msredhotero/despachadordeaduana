...
$resMenu = $serviciosHTML->menu(utf8_encode($_SESSION['nombre_predio']),"Buques",$_SESSION['refroll_predio'],'');
...
$eliminar = "eliminarBuques";

$insertar = "insertarBuques";
...
$lstCargados 	= $serviciosFunciones->camposTablaView($cabeceras,$serviciosReferencias->traerBuques(),1);
