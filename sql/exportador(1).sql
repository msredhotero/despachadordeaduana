...
--
-- Servidor: localhost
-- Tiempo de generación: 23-01-2018 a las 00:02:58
...
CREATE TABLE IF NOT EXISTS `dbexportaciondetalles` (
  ...
  `contenedor` varchar(120) COLLATE utf8_spanish_ci DEFAULT NULL,
  `tara` decimal(18,2) DEFAULT NULL,
  `precinto` varchar(120) COLLATE utf8_spanish_ci DEFAULT NULL,
